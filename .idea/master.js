...
// 랜덤 색깔
var c = ['#2C3e50', '#E74C3C', '#ECF0F1', '#3498DB', '#2980B9'];
// 원 객체 함수 생성
...
for (var i = 0; i < circlesSum; i++) {
    var x_1 = (Math.random() * 960) + 20;
    var y_1 = (Math.random() * 460) + 20;
    var radius_1 = (Math.random() * 10) + 10;
    var vx_1 = (Math.random() - 2) * 2;
    var vy_1 = (Math.random() - 2) * 2;
    // 각 공마다 크기를 갖기
    for (var j = 0; j < circles.length; j++) {
        ...
        console.log(typeof (vx_1));
    }
    circles.push(new Circle(x_1, y_1, radius_1));
}
